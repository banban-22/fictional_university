...
class OurWordFilterPlugin
{
    ...
    function ourMenu()
    {
        ...
        $mainPageHook = add_submenu_page('ourwordfilter', 'Words To Filter', 'Words List', 'manage_options', 'ourwordfilter', array($this, 'wordFilterPage'));
    ...
    function handleForm()
    {
        ...
        <?php } else { ?>
            <div class="error">
                <p>Sorry, you are not allowed to perform that action.</p>
            </div>
