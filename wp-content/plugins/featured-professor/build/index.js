...
function EditComponent(props) {
  ...
  function updateTheMeta() {
    const profsForMeta = wp.data.select('core/block-editor').getBlocks().filter(block => block.name === 'ourplugin/featured-professor').map(data => data.attributes.profId).filter((data, index, array) => {
