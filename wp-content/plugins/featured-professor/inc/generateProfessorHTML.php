            ...
            <div class="professor-callout__text">
                ...
                if ($relatedPrograms) { ?>
                    <p>
                        ...
                        <!-- the $key is index, and the $program is value -->
                        <?php foreach ($relatedPrograms as $key => $program) {
                            echo get_the_title($program);

                            // if the current program is not the last one in the list and if there is more than one related program
                ...
                <p><strong>
                        <a href="<?php the_permalink(); ?>">Learn more about
                            <?php the_title(); ?> &raquo;
                        </a>
                    </strong></p>
            </div>
