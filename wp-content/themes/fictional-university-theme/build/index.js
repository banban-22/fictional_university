...
//     if (currentLikeBox.attr('data-exist') == 'yes') {
...
class Like {
  ...
  ourClickDispatcher(e) {
    ...
    if (currentLikeBox.getAttribute('data-exist') == 'yes') {
      this.deleteLike(currentLikeBox);
    } else {
      this.createLike(currentLikeBox);
    }
  ...
  async createLike(currentLikeBox) {
    try {
      ...
      if (response.data != 'Only logged in users can create a like.') {
        currentLikeBox.setAttribute('data-exist', 'yes');
  ...
  async deleteLike(currentLikeBox) {
    try {
      ...
      currentLikeBox.setAttribute('data-exist', 'no');
      var likeCount = parseInt(currentLikeBox.querySelector('.like-count').innerHTML, 10);
      likeCount--;
      currentLikeBox.querySelector('.like-count').innerHTML = likeCount;
