...
function pageBanner($args = null)
{
    ...
    if (!isset($args['photo'])) {
        ...
        if ($field and !is_archive() and !is_home()) {
...
{
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDqFjsMhuw_VAkaNCW4blc9PKEjSbdu1Ck', NULL, '1.0', true);
...
{
    $api['key'] = 'AIzaSyDqFjsMhuw_VAkaNCW4blc9PKEjSbdu1Ck';
    return $api;
}
...
//         $regTitle = pref_replace('/^Private: /', '', $title);
//         return regTitle;
//     } else {
//         return $title;
//     }
